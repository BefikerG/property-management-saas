...
* The original package name 'com.propmanager.tenant-manager' is invalid and this project uses 'com.propmanager' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/3.5.15/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
